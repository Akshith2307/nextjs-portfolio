...
const EducationSection = () => {
  const educationEntries = [
    ...
    },
    {
      ...
      side: 'right',
      image: '/images/MRCET.webp', // Add the image URL here
    },
    // ... Add more entries as needed
  ];
  ...
  return (
    <section id="education">
      <div style={{ position: 'relative', width: '100%' }}>
        <h3 style={{ position: 'absolute', top: '-30px', left: '50%', transform: 'translateX(-50%)', color: 'white', fontSize: '27px', fontWeight: 'bold' }}>EDUCATION</h3>
        <div style={timelineStyle}>
          <div style={lineStyle}></div>
          {educationEntries.map((entry) => (
            <div key={entry.year} style={entryStyle(entry.side)}>
